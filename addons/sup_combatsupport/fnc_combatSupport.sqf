                ...
                */
                ...
                if (isServer) then {
...

                        {
                            ...
                            //FSM
                            [_units, _grp, _callsign, _pos, _artyAmmo, _canMove, _class, leader _grp, _code, _audio, _side] execFSM "\x\alive\addons\sup_combatSupport\scripts\NEO_radio\fsms\alivearty.fsm";
